...
public class MainMenu {
    ...
    private void buildUI() {
        ...
        label.setFont(
                new Font("Palatino Linotype", Font.BOLD, 80)
        );
        ...
        loadButton.addActionListener(e -> {
            ...
            MapPanel mapPanel = new MapPanel(frame, 0);
        ...
        JButton button = new JButton(text) {
...

            {
                fadeTimer = new Timer(16, e -> {
                    ...
                    if ((targetState && glowAlpha >= 1f)
                            ||
                            (!targetState && glowAlpha <= 0f)) {
